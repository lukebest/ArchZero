...
_METRIC_SPECS: tuple[tuple[str, str, str, str, str | None, bool], ...] = (
    ...
    ("t4_magic_gap", "magic_gap", "Magic Gap（模型 vs 全量仿真）", "x", "max_magic_gap", False),
    ...
    ("t3_jitter_tolerance", "jitter_tolerance", "抖动下尾时延恶化（小规模仿真）", "x", None, False),
    ("t2_jitter_tolerance", "jitter_tolerance", "抖动下尾时延恶化（解析模型）", "x", None, False),
    ("t3_coverage", "coverage", "实验矩阵覆盖率（小规模仿真）", "frac", None, True),
    ("t2_coverage", "coverage", "实验矩阵覆盖率（解析模型）", "frac", None, True),
